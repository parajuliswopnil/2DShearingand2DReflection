...
shearingValue = int(input('Enter the shearing value: '))
transformationVector.append((1, shearingValue, 0))
transformationVector.append((0, 1, 0))
...
pygame.gfxdraw.filled_polygon(drawingSurface, transposedFinalCoordinate, colorGreen)
